 ...
 * of the temporary stream wrapper.
 *
 * @package TechDivision_StreamWrapper
 ...
 * @license GPL
 */
class TechDivision_StreamWrapper_TemporaryTest
	...
	public function testStreamWrite()
	{
	    ...
	    $toWrite = file_get_contents(
	    	'TechDivision/StreamWrapper/TestClass.php',
	        true
	    );
	    // initialize the stream URL
	    $stream = 'tmp://TechDivision/StreamWrapper/TestClass.php';
	    ...
	    $test = new TechDivision_StreamWrapper_TestClass($name = 'Foo');
